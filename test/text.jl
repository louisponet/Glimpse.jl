...
Gl.new_entity!(dio, separate=[Gl.Spatial(), Gl.Shape(), Gl.Material(), Gl.ProgramTag{Gl.PeelingProgram}(), Gl.UniformColor(RGBAf0(0.0, 1.0,0.0,1.0)), Gl.PolygonGeometry(Sphere(zero(Point3f0), 1.0f0))])
